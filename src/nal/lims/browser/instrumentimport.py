...
class GalleryImportView(edit.DefaultEditForm):
    ...
    def processCSV(self, data):
        ...
        for i in import_samples:
            ...
            #Nitrate
            if nitrate is not None and api.get_workflow_status_of(nitrate) in ['unassigned','retracted'] and not filtered_df[(filtered_df['Sample Name']==api.get_id(i)) & (filtered_df['Test']=='SAPNO3')].empty and not filtered_df[(filtered_df['Sample Name']==api.get_id(i)) & (filtered_df['Test']=='SAPTON1S')].empty:
