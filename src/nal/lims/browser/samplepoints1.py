...
from bika.lims.controlpanel.bika_samplepoints import SamplePointsView as BikaSamplePointsView

# TODO: Separate content and view into own modules!


class SamplePointsView(BikaSamplePointsView):
    ...
    def __init__(self, context, request):
        ...
        self.title = self.context.translate(_("Sample Locations"))
        self.icon = "{}/{}".format(
            self.portal_url,
