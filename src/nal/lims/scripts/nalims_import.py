...
sap_p = api.create(analysisservices, "AnalysisService", title="Phosphorous (P)", Keyword = "sap_phosphorus", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=sapcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
...
liqfert_phosphorus = api.create(analysisservices, "AnalysisService", title="Phosphorous (P)", Keyword="liqfert_phosphorus", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
