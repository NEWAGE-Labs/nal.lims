...
liqfert_soluablesalts = api.create(analysisservices, "AnalysisService", title="Soluable Salts", Keyword="liqfert_soluablesalts", Methods=sm2540c, Accredited=True, Unit="mS/cm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.01", ExponentialFormatPrecision=7).UID()
liqfert_tds = api.create(analysisservices, "AnalysisService", title="Total Dissolved Solids (TDS)", Keyword="liqfert_tds", Methods=sm2510b, Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.1", ExponentialFormatPrecision=7).UID()
liqfert_chloride = api.create(analysisservices, "AnalysisService", title="Chloride (Cl-)", Keyword="liqfert_chloride", Methods=sm4500_cl, Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_sulfur = api.create(analysisservices, "AnalysisService", title="Sulfur (S)", Keyword="liqfert_sulfur", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_phosphorus = api.create(analysisservices, "AnalysisService", title="Phosphorous (P)", Keyword="liqfert_phosphorous", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_calcium = api.create(analysisservices, "AnalysisService", title="Calcium (Ca)", Keyword="liqfert_calcium", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_potassium = api.create(analysisservices, "AnalysisService", title="Potassium (K)", Keyword="liqfert_potassium", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_magnesium = api.create(analysisservices, "AnalysisService", title="Magnesium (Mg)", Keyword="liqfert_magnesium", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_sodium = api.create(analysisservices, "AnalysisService", title="Sodium (Na)", Keyword="liqfert_sodium", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_aluminum = api.create(analysisservices, "AnalysisService", title="Aluminum (Al)", Keyword="liqfert_aluminum", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_boron = api.create(analysisservices, "AnalysisService", title="Boron (B)", Keyword="liqfert_boron", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_cobalt = api.create(analysisservices, "AnalysisService", title="Cobalt (Co)", Keyword="liqfert_cobalt", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_copper = api.create(analysisservices, "AnalysisService", title="Copper (Cu)", Keyword="liqfert_copper", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_iron = api.create(analysisservices, "AnalysisService", title="Iron (Fe)", Keyword="liqfert_iron", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_manganese = api.create(analysisservices, "AnalysisService", title="Manganese (Mn)", Keyword="liqfert_manganese", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_molybdenum = api.create(analysisservices, "AnalysisService", title="Molybdenum (Mo)", Keyword="liqfert_molybdenum", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_nickel = api.create(analysisservices, "AnalysisService", title="Nickel (Ni)", Keyword="liqfert_nickel", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_selenium = api.create(analysisservices, "AnalysisService", title="Selenium (Se)", Keyword="liqfert_selenium", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_silica = api.create(analysisservices, "AnalysisService", title="Silica (Si)", Keyword="liqfert_silica", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_zinc = api.create(analysisservices, "AnalysisService", title="Zinc (Zn)", Keyword="liqfert_zinc", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.05", ExponentialFormatPrecision=7).UID()
liqfert_ammonia = api.create(analysisservices, "AnalysisService", title="Ammonia (NH4) as Nitrogen (N)", Keyword="liqfert_ammonia", Methods=sm4500_no3d, Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.01", ExponentialFormatPrecision=7).UID()
liqfert_nitrate = api.create(analysisservices, "AnalysisService", title="Nitrate (NO3) as Nitrogen (N)", Keyword="liqfert_nitrate", Methods=sm4500_modnh3, Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.01", ExponentialFormatPrecision=7).UID()
