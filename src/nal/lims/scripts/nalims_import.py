...
##Sap
sap_al = api.create(analysisservices, "AnalysisService", title="Aluminum (Al)", Keyword = "sap_aluminum", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_b = api.create(analysisservices, "AnalysisService", title="Boron (B)", Keyword = "sap_boron", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_brix = api.create(analysisservices, "AnalysisService", title="Brix", Keyword = "sap_brix", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_sugar = api.create(analysisservices, "AnalysisService", title="Sugars, Total", Keyword = "sap_total_sugar", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_ca = api.create(analysisservices, "AnalysisService", title="Calcium (Ca)", Keyword = "sap_calcium", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_cl = api.create(analysisservices, "AnalysisService", title="Chloride (Cl-)", Keyword = "sap_chloride", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_co = api.create(analysisservices, "AnalysisService", title="Cobalt (Co)", Keyword = "sap_cobalt", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_cu = api.create(analysisservices, "AnalysisService", title="Copper (Cu)", Keyword = "sap_copper", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_ec = api.create(analysisservices, "AnalysisService", title="EC", Keyword = "sap_ec", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_fe = api.create(analysisservices, "AnalysisService", title="Iron (Fe)", Keyword = "sap_iron", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_kca = api.create(analysisservices, "AnalysisService", title="K/Ca Ratio", Keyword = "sap_kcaratio", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_mg = api.create(analysisservices, "AnalysisService", title="Magnesium (Mg)", Keyword = "sap_magnesium", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_mn = api.create(analysisservices, "AnalysisService", title="Manganese (Mn)", Keyword = "sap_manganese", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_mo = api.create(analysisservices, "AnalysisService", title="Molybdenum (Mo)", Keyword = "sap_molybdenum", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_ni = api.create(analysisservices, "AnalysisService", title="Nickel (Ni)", Keyword = "sap_nickel", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_no3 = api.create(analysisservices, "AnalysisService", title="Nitrate (NO3)", Keyword = "sap_nitrate", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_nnh4 = api.create(analysisservices, "AnalysisService", title="Nitrogen as Ammonium (NH4)", Keyword = "sap_nitrogen_as_ammonium", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_nno3 = api.create(analysisservices, "AnalysisService", title="Nitrogen as Nitrate (NO3)", Keyword = "sap_nitrogen_as_nitrate", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_totaln = api.create(analysisservices, "AnalysisService", title="Nitrogen (N), Total", Keyword = "sap_total_nitrogen", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_ph = api.create(analysisservices, "AnalysisService", title="pH", Keyword = "sap_ph", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_p = api.create(analysisservices, "AnalysisService", title="Phosphorous (P)", Keyword = "sap_phosphorous", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_k = api.create(analysisservices, "AnalysisService", title="Potassium (K)", Keyword = "sap_potassium", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_se = api.create(analysisservices, "AnalysisService", title="Selenium (Se)", Keyword = "sap_selenium", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_si = api.create(analysisservices, "AnalysisService", title="Silica (Si)", Keyword = "sap_silica", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_na = api.create(analysisservices, "AnalysisService", title="Sodium (Na)", Keyword = "sap_sodium", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_s = api.create(analysisservices, "AnalysisService", title="Sulfur (S)", Keyword = "sap_sulfur", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()
sap_zn = api.create(analysisservices, "AnalysisService", title="Zinc (Zn)", Keyword = "sap_zinc", Accredited=True, PointOfCapture="lab", Category=sapcategory, ExponentialFormatPrecision=7, Precision=3).UID()

##Drinking Water

drinking_f = api.create(analysisservices, "AnalysisService", title="Flouride (F)", Keyword = "drinking_flouride", Accredited=True, PointOfCapture="lab", Category=drinkingcategory, ExponentialFormatPrecision=7, Precision=3).UID()
drinking_pb = api.create(analysisservices, "AnalysisService", title="Lead (Pb)", Keyword = "drinking_lead", Accredited=True, PointOfCapture="lab", Category=drinkingcategory, ExponentialFormatPrecision=7, Precision=3).UID()
drinking_cu = api.create(analysisservices, "AnalysisService", title="Copper (Cu)", Keyword = "drinking_copper", Accredited=True, PointOfCapture="lab", Category=drinkingcategory, ExponentialFormatPrecision=7, Precision=3).UID()
drinking_no2 = api.create(analysisservices, "AnalysisService", title="Nitrite (NO2)", Keyword = "drinking_nitrite", Accredited=True, PointOfCapture="lab", Category=drinkingcategory, ExponentialFormatPrecision=7, Precision=3).UID()
drinking_no3 = api.create(analysisservices, "AnalysisService", title="Nitrate (NO3)", Keyword = "drinking_nitrate", Accredited=True, PointOfCapture="lab", Category=drinkingcategory, ExponentialFormatPrecision=7, Precision=3).UID()
drinking_coliform_mpn = api.create(analysisservices, "AnalysisService", title="Coliform (MPN)", Keyword = "drinking_coliform_mpn", Accredited=True, PointOfCapture="lab", Category=drinkingcategory, ExponentialFormatPrecision=7, Precision=3).UID()
drinking_ecoli_mpn = api.create(analysisservices, "AnalysisService", title="E.coli (MPN)", Keyword = "drinking_ecoli_mpn", Accredited=True, PointOfCapture="lab", Category=drinkingcategory, ExponentialFormatPrecision=7, Precision=3).UID()
drinking_coliform_pa = api.create(analysisservices, "AnalysisService", title="Coliform (PA)", Keyword = "drinking_coliform_pa", Accredited=True, PointOfCapture="lab", Category=drinkingcategory, ExponentialFormatPrecision=7, Precision=3).UID()
drinking_ecoli_pa = api.create(analysisservices, "AnalysisService", title="E.coli (PA)", Keyword = "drinking_ecoli_pa", Accredited=True, PointOfCapture="lab", Category=drinkingcategory, ExponentialFormatPrecision=7, Precision=3).UID()
drinking_fecal = api.create(analysisservices, "AnalysisService", title="Fecal Coliform", Keyword = "drinking_fecal_coliform", Accredited=True, PointOfCapture="lab", Category=drinkingcategory, ExponentialFormatPrecision=7, Precision=3).UID()

##Hydro Water

hydro_ph = api.create(analysisservices, "AnalysisService", title="pH", keyword="hydro_ph", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_soluablesalts = api.create(analysisservices, "AnalysisService", title="Soluable Salts", keyword="hydro_soluablesalts", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_tds = api.create(analysisservices, "AnalysisService", title="Total Dissolved Solids (TDS)", keyword="hydro_tds", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_chloride = api.create(analysisservices, "AnalysisService", title="Chloride (Cl-)", keyword="hydro_chloride", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_sulfur = api.create(analysisservices, "AnalysisService", title="Sulfur (S)", keyword="hydro_sulfur", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_phosphorus = api.create(analysisservices, "AnalysisService", title="Phosphorus (P)", keyword="hydro_phosphorus", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_calcium = api.create(analysisservices, "AnalysisService", title="Calcium (Ca)", keyword="hydro_calcium", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_potassium = api.create(analysisservices, "AnalysisService", title="Potassium (K)", keyword="hydro_potassium", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_magnesium = api.create(analysisservices, "AnalysisService", title="Magnesium (Mg)", keyword="hydro_magnesium", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_sodium = api.create(analysisservices, "AnalysisService", title="Sodium (Na)", keyword="hydro_sodium", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_aluminum = api.create(analysisservices, "AnalysisService", title="Aluminum (Al)", keyword="hydro_aluminum", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_boron = api.create(analysisservices, "AnalysisService", title="Boron (B)", keyword="hydro_boron", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_cobalt = api.create(analysisservices, "AnalysisService", title="Cobalt (Co)", keyword="hydro_cobalt", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_copper = api.create(analysisservices, "AnalysisService", title="Copper (Cu)", keyword="hydro_copper", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_iron = api.create(analysisservices, "AnalysisService", title="Iron (Fe)", keyword="hydro_iron", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_manganese = api.create(analysisservices, "AnalysisService", title="Manganese (Mn)", keyword="hydro_manganese", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_molybdenum = api.create(analysisservices, "AnalysisService", title="Molybdenum (Mo)", keyword="hydro_molybdenum", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_nickel = api.create(analysisservices, "AnalysisService", title="Nickel (Ni)", keyword="hydro_nickel", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_selenium = api.create(analysisservices, "AnalysisService", title="Selenium (Se)", keyword="hydro_selenium", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_silica = api.create(analysisservices, "AnalysisService", title="Silica (Si)", keyword="hydro_silica", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_zinc = api.create(analysisservices, "AnalysisService", title="Zinc (Zn)", keyword="hydro_zinc", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_ammonia = api.create(analysisservices, "AnalysisService", title="Ammonia (NH4) as Nitrogen (N)", keyword="hydro_ammonia", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
hydro_nitrate = api.create(analysisservices, "AnalysisService", title="Nitrate (NO3) as Nitrogen (N)", keyword="hydro_nitrate", Accredited=True, PointOfCapture="lab", Category=hydrocategory, ExponentialFormatPrecision=7, Precision=3).UID()
