...
liqfert_ammonia = api.create(analysisservices, "AnalysisService", title="Ammonia (NH3) as Nitrogen (N)", Keyword="liqfert_ammonia", Methods=sm4500_modnh3, Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.01", Precision=2, ExponentialFormatPrecision=7).UID()
liqfert_nitrate = api.create(analysisservices, "AnalysisService", title="Nitrate (NO3) as Nitrogen (N)", Keyword="liqfert_nitrate", Methods=sm4500_no3d, Accredited=True, Unit="ppm", PointOfCapture="lab", Category=liqfertcategory, LowerDetectionLimit="0.01", Precision=2, ExponentialFormatPrecision=7).UID()
...
basic_soil_chloride = api.create(analysisservices, "AnalysisService", title="Chloride (Cl-)", Keyword="basic_soil_chloride", Methods=[sm4500_cl], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_sulfur = api.create(analysisservices, "AnalysisService", title="Sulfur (S)", Keyword="basic_soil_sulfur", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_phosphorus = api.create(analysisservices, "AnalysisService", title="Phosphorus (P)", Keyword="basic_soil_phosphorus", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
...
basic_soil_potassium = api.create(analysisservices, "AnalysisService", title="Potassium (K)", Keyword="basic_soil_potassium", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_magnesium = api.create(analysisservices, "AnalysisService", title="Magnesium (Mg)", Keyword="basic_soil_magnesium", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_sodium = api.create(analysisservices, "AnalysisService", title="Sodium (Na)", Keyword="basic_soil_sodium", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_percent_calcium = api.create(analysisservices, "AnalysisService", title="% Calcium (Ca)", Keyword="basic_soil_percent_calcium", Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_percent_potassium = api.create(analysisservices, "AnalysisService", title="% Potassium (K)", Keyword="basic_soil_percent_potassium", Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_percent_magnesium = api.create(analysisservices, "AnalysisService", title="% Magnesium (Mg)", Keyword="basic_soil_percent_magnesium", Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_esp = api.create(analysisservices, "AnalysisService", title="ESP", Keyword="basic_soil_esp", Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_aluminum = api.create(analysisservices, "AnalysisService", title="Aluminum (Al)", Keyword="basic_soil_aluminum", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_boron = api.create(analysisservices, "AnalysisService", title="Boron (B)", Keyword="basic_soil_boron", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_cobalt = api.create(analysisservices, "AnalysisService", title="Cobalt (Co)", Keyword="basic_soil_cobalt", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_copper = api.create(analysisservices, "AnalysisService", title="Copper (Cu)", Keyword="basic_soil_copper", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_iron = api.create(analysisservices, "AnalysisService", title="Iron (Fe)", Keyword="basic_soil_iron", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_manganese = api.create(analysisservices, "AnalysisService", title="Manganese (Mn)", Keyword="basic_soil_manganese", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_molybdenum = api.create(analysisservices, "AnalysisService", title="Molybdenum (Mo)", Keyword="basic_soil_molybdenum", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_nickel = api.create(analysisservices, "AnalysisService", title="Nickel (Ni)", Keyword="basic_soil_nickel", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_selenium = api.create(analysisservices, "AnalysisService", title="Selenium (Se)", Keyword="basic_soil_selenium", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_silica = api.create(analysisservices, "AnalysisService", title="Silica (Si)", Keyword="basic_soil_silica", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_zinc = api.create(analysisservices, "AnalysisService", title="Zinc (Zn)", Keyword="basic_soil_zinc", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
...
basic_soil_arsenic = api.create(analysisservices, "AnalysisService", title="Arsenic (As)", Keyword="basic_soil_arsenic", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.5", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_cadmium = api.create(analysisservices, "AnalysisService", title="Cadmium (Cd)", Keyword="basic_soil_cadmium", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.5", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_chromium = api.create(analysisservices, "AnalysisService", title="Chromium (Cr)", Keyword="basic_soil_chromium", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.5", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_lead = api.create(analysisservices, "AnalysisService", title="Lead (Pb)", Keyword="basic_soil_lead", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.5", Precision=2, ExponentialFormatPrecision=7).UID()
basic_soil_mercury = api.create(analysisservices, "AnalysisService", title="Mercury (Hg)", Keyword="basic_soil_mercury", Methods=[epa7471b], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.5", Precision=2, ExponentialFormatPrecision=7).UID()
...
rapid_soil_sulfur = api.create(analysisservices, "AnalysisService", title="Sulfur (S)", Keyword="rapid_soil_sulfur", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_phosphorus = api.create(analysisservices, "AnalysisService", title="Phosphorus (P)", Keyword="rapid_soil_phosphorus", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
...
rapid_soil_potassium = api.create(analysisservices, "AnalysisService", title="Potassium (K)", Keyword="rapid_soil_potassium", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_magnesium = api.create(analysisservices, "AnalysisService", title="Magnesium (Mg)", Keyword="rapid_soil_magnesium", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_sodium = api.create(analysisservices, "AnalysisService", title="Sodium (Na)", Keyword="rapid_soil_sodium", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_percent_calcium = api.create(analysisservices, "AnalysisService", title="% Calcium (Ca)", Keyword="rapid_soil_percent_calcium", Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_percent_potassium = api.create(analysisservices, "AnalysisService", title="% Potassium (K)", Keyword="rapid_soil_percent_potassium", Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_percent_magnesium = api.create(analysisservices, "AnalysisService", title="% Magnesium (Mg)", Keyword="rapid_soil_percent_magnesium", Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_esp = api.create(analysisservices, "AnalysisService", title="ESP", Keyword="rapid_soil_esp", Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_aluminum = api.create(analysisservices, "AnalysisService", title="Aluminum (Al)", Keyword="rapid_soil_aluminum", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_boron = api.create(analysisservices, "AnalysisService", title="Boron (B)", Keyword="rapid_soil_boron", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_cobalt = api.create(analysisservices, "AnalysisService", title="Cobalt (Co)", Keyword="rapid_soil_cobalt", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_copper = api.create(analysisservices, "AnalysisService", title="Copper (Cu)", Keyword="rapid_soil_copper", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_iron = api.create(analysisservices, "AnalysisService", title="Iron (Fe)", Keyword="rapid_soil_iron", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_manganese = api.create(analysisservices, "AnalysisService", title="Manganese (Mn)", Keyword="rapid_soil_manganese", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_molybdenum = api.create(analysisservices, "AnalysisService", title="Molybdenum (Mo)", Keyword="rapid_soil_molybdenum", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_nickel = api.create(analysisservices, "AnalysisService", title="Nickel (Ni)", Keyword="rapid_soil_nickel", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_selenium = api.create(analysisservices, "AnalysisService", title="Selenium (Se)", Keyword="rapid_soil_selenium", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_silica = api.create(analysisservices, "AnalysisService", title="Silica (Si)", Keyword="rapid_soil_silica", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_zinc = api.create(analysisservices, "AnalysisService", title="Zinc (Zn)", Keyword="rapid_soil_zinc", Methods=[aoac993_14], Accredited=True, Unit='ppm',PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.05", Precision=2, ExponentialFormatPrecision=7).UID()
...
rapid_soil_arsenic = api.create(analysisservices, "AnalysisService", title="Arsenic (As)", Keyword="rapid_soil_arsenic", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.5", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_cadmium = api.create(analysisservices, "AnalysisService", title="Cadmium (Cd)", Keyword="rapid_soil_cadmium", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.5", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_chromium = api.create(analysisservices, "AnalysisService", title="Chromium (Cr)", Keyword="rapid_soil_chromium", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.5", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_lead = api.create(analysisservices, "AnalysisService", title="Lead (Pb)", Keyword="rapid_soil_lead", Methods=[aoac993_14], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.5", Precision=2, ExponentialFormatPrecision=7).UID()
rapid_soil_mercury = api.create(analysisservices, "AnalysisService", title="Mercury (Hg)", Keyword="rapid_soil_mercury", Methods=[epa7471b], Accredited=True, Unit="ppm", PointOfCapture="lab", Category=soilcategory, LowerDetectionLimit="0.5", Precision=2, ExponentialFormatPrecision=7).UID()
