...
#
#  $ bin/test -s nal.lims -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src nal.lims.testing.NAL_LIMS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/nal/lims/tests/robot/test_example.robot
#
